...
def _uses_qwen3_vl_style_video_grid(model_type: str) -> bool:
    return (
        model_type.startswith("qwen3_vl")
        or model_type.startswith("qwen3_vl_moe")
        or model_type.startswith("qwen3_5")
        or model_type == "dstar_vl"
    )


def _uses_qwen3_vl_style_t_index(model_type: str) -> bool:
...
def get_rope_index(
    ...
    **kwargs,
    ...
    if _uses_qwen3_vl_style_video_grid(model_type) and video_grid_thw is not None:
    ...
    if input_ids is not None and (
        ...
        for i, input_ids in enumerate(total_input_ids):
            ...
            for _ in range(image_nums + video_nums):
                ...
                elif _uses_qwen3_vl_style_t_index(model_type):
                    t_index = (
