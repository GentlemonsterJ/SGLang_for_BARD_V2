...
class GenerateReqInput(BaseReq):
    ...
    # Whether to return Dstar diffusion unmask step map
    return_step_map: Union[List[bool], bool] = False
    # Whether to return Dstar diffusion unmask confidence map
    return_step_confidence_map: Union[List[bool], bool] = False
    ...
    def __getitem__(self, i):
        return GenerateReqInput(
            ...
            return_step_map=(
                self.return_step_map[i]
                if isinstance(self.return_step_map, list)
                else self.return_step_map
            ),
            return_step_confidence_map=(
                self.return_step_confidence_map[i]
                if isinstance(self.return_step_confidence_map, list)
                else self.return_step_confidence_map
            ),
