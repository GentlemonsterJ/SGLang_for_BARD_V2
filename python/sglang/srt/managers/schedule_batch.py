...
class Req(ReqDllmMixin):
    ...
    def __init__(
        ...
        return_step_confidence_map: bool = False,
        ...
        self.return_step_map = return_step_map
        self.return_step_confidence_map = return_step_confidence_map
...
class ScheduleBatch(ScheduleBatchDisaggregationDecodeMixin):
    ...
    # Whether to return Dstar diffusion metadata
    return_step_map: bool = False
    return_step_confidence_map: bool = False
    ...
    def init_new(
        ...
        return cls(
            ...
            return_step_map=any(req.return_step_map for req in reqs),
            return_step_confidence_map=any(
                req.return_step_confidence_map for req in reqs
            ),
    ...
    def get_model_worker_batch(
        ...
        return ModelWorkerBatch(
            ...
            return_step_map=[req.return_step_map for req in self.reqs],
            return_step_confidence_map=[
                req.return_step_confidence_map for req in self.reqs
            ],
            reqs=self.reqs,
