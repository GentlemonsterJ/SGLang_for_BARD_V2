    ...
    def _create_tokenized_object(
        ...
        if isinstance(obj, GenerateReqInput):
            ...
            tokenized_obj = TokenizedGenerateReqInput(
                ...
                return_step_map=obj.return_step_map,
                return_step_confidence_map=obj.return_step_confidence_map,
        ...
        for i, rid in enumerate(recv_obj.rids):
            ...
            if getattr(recv_obj, "customized_info", None):
                ...
                for k, v in recv_obj.customized_info.items():
                    chunk_value = v[i]
                    if is_stream:
                        meta_info[k] = chunk_value
                    else:
                        state.customized_info.setdefault(k, []).extend(chunk_value)
                        meta_info[k] = state.customized_info[k]
