...
class GenerationBatchResult:
    ...
    step_map: Optional[List[List[int]]] = None
    step_confidence_map: Optional[List[List[float]]] = None
    verify_accept_map: Optional[List[List[bool]]] = None
    verify_logprob_map: Optional[List[List[float]]] = None
