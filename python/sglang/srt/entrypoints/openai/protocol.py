...
class SglExt(BaseModel):
    ...
    step_map: Optional[Union[List[int], List[List[int]]]] = None
    step_confidence_map: Optional[Union[List[float], List[List[float]]]] = None
    token_logprobs: Optional[
        Union[List[Optional[float]], List[List[Optional[float]]]]
    ] = None
    token_ids: Optional[Union[List[int], List[List[int]]]] = None
