...
class DllmConfig:
    ...
    def from_server_args(
        ...
        DLLM_PARAMS = {
            ...
            "DstarVLForConditonalGeneration": {"block_size": 4, "mask_id": 151671}, # new added.
        }
        ...
        verifier_threshold = algorithm_config.get(
            "verifier_threshold",
            server_args.dllm_verifier_threshold,
        )
        ...
        return DllmConfig(
            ...
            verifier_revision=server_args.dllm_verifier_revision,
