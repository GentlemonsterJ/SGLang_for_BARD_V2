...
from sglang.srt.models.dstar_vl import DstarVLForConditonalGeneration
...
_QWEN3_VL_VIDEO_METADATA_MODEL_TYPES = frozenset(
    {
        "qwen3_vl",
        "qwen3_vl_moe",
        "qwen3_5",
...
def _uses_qwen3_vl_video_metadata(model_type: str) -> bool:
    return model_type in _QWEN3_VL_VIDEO_METADATA_MODEL_TYPES
...
class QwenVLImageProcessor(SGLangBaseProcessor):
    models = [
        ...
        DstarVLForConditonalGeneration,
    ]
    ...
    async def process_mm_data_async(
        ...
        **kwargs,
        ...
        if _uses_qwen3_vl_video_metadata(self.hf_config.model_type):
